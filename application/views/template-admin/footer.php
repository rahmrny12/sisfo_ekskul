...
<footer>
  <div class="pull-right">
    Aplikasi Sistem Informasi Ekstrakurikuler (Sisfo Ekskul). Copyright <?= date('Y') ?>
  </div>
...
<!-- moris js -->
<link rel="stylesheet" href="<?= base_url('vendor/morris_js/') ?>morris.css">
<script src="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.3.0/raphael.min.js"></script>
<script src="<?= base_url('vendor/morris_js/') ?>morris.min.js"></script>
